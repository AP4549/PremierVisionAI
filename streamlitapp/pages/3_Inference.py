...
with st.sidebar:
    st.title("Navigation")
    page = st.radio("Go to:", ["🔍 Make Predictions","🏠 Home", "🧠 Model Architecture","📊 Benchmarks & Stats","🚀 Object Detection","🖼️ Image Segmentation","🎨 Neural Style Transfer"])
...
if page == "🏠 Home":
    ...
    st.switch_page("pages/4_Object_Detection.py")
